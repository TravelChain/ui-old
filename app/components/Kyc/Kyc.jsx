            ...
            <div className="grid-block vertical">
                <div className="grid-block shrink vertical medium-horizontal" style={{paddingTop: "2rem"}}>
                    ...
                    <form style={{paddingBottom: 20, overflow: "visible"}}
                          className="grid-content small-12 medium-6 large-5 large-offset-1 full-width-content user-form"
                        ...
                        <div className="content-block transfer-input">
                            ...
                            <MuiThemeProvider>
                                <IconButton
                                    ...
                                    aria-haspopup="true"
                                    onClick={(e) => {
                                        this.getDatepickerPopuper().openDialog()
                                    }}
                                >
                                    <DatePickerIcon/>
                                </IconButton>
                            ...
                            <div className="datepicker-by-icon">
                                <MuiThemeProvider muiTheme={travelchainTheme}>
                                    <DatePicker
                                        ref={(input) => {
                                            this.setDatepickerPopuper(input);
                                        }}
                                        onChange={(something, date) => {
                        ...
                        <div className="content-block transfer-input">
                            <div
                                className="MuiFormControl-root-1 MuiFormControl-marginNormal-2 MuiFormControl-fullWidth-4 c1 c2 c4">
                                {/*<Translate className="left-label tooltip" component="label" content="kyc.phone" data-place="top"/>*/}
                                <label data-shrink="true"
                                       className="MuiFormLabel-root-11 MuiInputLabel-root-5 MuiInputLabel-formControl-6 MuiInputLabel-animated-9 MuiInputLabel-shrink-8 c11 c5 c6 c9 c8"
                                       htmlFor="phone">Phone<span class=""> *</span></label>
                                ...
                                {/*/>*/}
                                <div
                                    className="MuiInput-root-15 MuiInput-formControl-16 MuiInput-inkbar-17 MuiInput-underline-21 c15 c16 c17 c21">
                                    <InputMask value={phone} onChange={this.updatePhoneNumber}
                                               className="MuiInput-input-24 MuiInput-inputSingleline-27 c24 c27 phoneInput"
                                               mask="+9999999999999999999999" maskChar=" "/>
                                </div>
                        ...
                        <div className="confirm-checks">
                            <label>
                                <input value={isAgreedTerms} id='terms_agreement_checkbox' type="checkbox"
                                       onChange={(e) => {
                                           this.setState({isAgreedTerms: e.target.value == "false"})
                                       }}/>
                        ...
                        <div className="confirm-checks">
                            <label>
                                <input value={isAgreedTermsTokens} id='terms_agreement_checkbox_2' type="checkbox"
                                       onChange={(e) => this.setState({isAgreedTermsTokens: e.target.value == "false"})}/>
                        ...
                        <button className={classnames("button float-right no-margin", {disabled: isSendNotValid})}
