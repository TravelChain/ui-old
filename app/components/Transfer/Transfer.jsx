...
import AccountSelector from "../Account/AccountSelectorMaterial";
import AccountStore from "stores/AccountStore";
import AmountSelector from "../Utility/AmountSelectorMaterial";
import AmountSelectorOld from "../Utility/AmountSelector";
...
class Transfer extends React.Component {
    ...
    render() {
        let from_error = null;
        let {
            propose, from_account, to_account, asset, asset_id, propose_account, feeAmount,
            amount, error, to_name, from_name, memo, feeAsset, fee_asset_id, balanceError
        } = this.state;
            ...
            <div className="grid-block vertical">
                <div className="grid-block shrink vertical medium-horizontal" style={{paddingTop: "2rem"}}>
                    ...
                    <form style={{paddingBottom: 20, overflow: "visible"}}
                          className="grid-content small-12 medium-6 large-5 large-offset-1 full-width-content transfer-form"
                          onSubmit={this.onSubmit.bind(this)} noValidate>

                        <Translate content="transfer.header" component="h2"/>
                        {/*  F R O M  */}
                        <div className="content-block">
                            <AccountSelector label="FROM" ref="from"
